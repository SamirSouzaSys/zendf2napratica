...
class PostTest extends ModelTestCase{
    ...
    */
    public function testInsert(){
        ...
        $this->assertEquals('A Apple compra a Coderock', $saved->description);
    ...
    */
    ...
    public function testUpdate(){
        ...
        $this->assertEquals('Apple compra a Coderock',$post->title);

        $post->title = 'Coderock compra a Apple';
        $updated = $tableGateway->save($post);
        
        $post = $tableGateway->get($id);
        $this->assertEquals('Coderock compra a Apple',$post->title);
    }
    ...
    */
    public function testDelete(){
        ...
        $this->assertEquals(1,$deleted); //número de linhas excluídas
    }
