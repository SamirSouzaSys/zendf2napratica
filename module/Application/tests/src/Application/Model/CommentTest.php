...
class CommentTest extends ModelTestCase {
    ...
    public function testInputFilterInvalido() {
        ...
        $comment->email = 'Lorem Ipsum é simplesmente uma simulação de texto da indústria tipográfica e de impressos. Lorem Ipsum é simplesmente uma simulação de texto da indústria tipográfica e de impressos';
    }
     ...
     * @expectedExceptionMessage Input inválido: id = 
     */
